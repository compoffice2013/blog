...
コンプオフィスのプロマジシャンや、パフォーマーのハルキさんなどが日替わりで出演しています。

今月2月はコンプレッサーも2日間続けて出演させていただきました。
普段はステージに立つことが多い中、こうした場での出演は非常に貴重な機会です。

## ステージとは一味違う！テーブルマジックの魅力

普段のメインとなる仕事は、やはり大勢のお客様に向けたステージマジックです。
トークとコミュニケーションで会場全体を巻き込み、一体感を作り上げるスタイルですが、ここ「ショーマン」でお届けするのは、それとは全く異なるジャンル「テーブルマジック（バーマジック）」。

<!-- 画像配置: ここに[テーブルマジック カード]を含むALT属性の画像を配置してください -->

テーブルマジックの最大の魅力は、なんといってもその距離感。
マジシャンの手元がすぐそこに見えるほどの至近距離で、コインやトランプが消えたり現れたりする様子は、まさに不思議そのものです。

「え、今何が起きたの？」

目の前で起こる現象に、脳が追いつかない。
そんな時間を味わえるのは、バーという空間ならではの醍醐味でしょう。
